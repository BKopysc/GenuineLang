...
public class GLangParser extends Parser {
	...
	public static final int
		...
		RULE_functionCallParams = 11, RULE_instructionStat = 12, RULE_returnStat = 13, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"functionCall", "functionCallParams", "instructionStat", "returnStat", 
	...
	public final InstructionStatContext instructionStat() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_instructionStat);
		try {
			setState(153);
			_errHandler.sync(this);

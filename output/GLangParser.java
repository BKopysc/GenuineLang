...
public class GLangParser extends Parser {
	...
	public static final int
		...
		RULE_elseBlock = 14, RULE_ifCondition = 15, RULE_elseCondition = 16, RULE_condition = 17, 
		RULE_expr = 18, RULE_value = 19;
	...
	public final NestedFunctionBlockContext nestedFunctionBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 19431904L) != 0)) {
				{
				{
				setState(61);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2654688L) != 0)) {
					{
					setState(60);
					functionLine();
					}
